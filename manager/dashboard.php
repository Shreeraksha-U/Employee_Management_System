...
<?php
        ...
        require_once "../connection.php";
         ...
         $next_week = 0;
            $i = 1;
        // total managers
        $select_managers = "SELECT * FROM manager";
        $total_managers = mysqli_query($conn , $select_managers);
        ...
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Managers</li>
                    <li class="list-group-item">Total Managers : <?php echo mysqli_num_rows($total_managers); ?> </li>
                    <li class="list-group-item text-center"><a href="manage-manager.php"><b>View All Managers</b></a></li>
                </ul>
            </div>
        </div>
        <div class="col-4">
