            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                   <br> <br>       
                    ...
                    <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-address-card-o menu-icon"></i><span class="nav-text">Manager</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./add-manager.php"> <i class="icon-plus menu-icon"></i><span class="nav-text">Add Manager</span></a></li>
                            <li><a href="./manage-manager.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Manage Managers</span></a></li>
                        </ul>
                    </li>   
                    <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
